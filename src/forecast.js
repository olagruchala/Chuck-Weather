...
const forecastStorage = (storageCity) => {
    fetch(`http://api.openweathermap.org/data/2.5/forecast?q=${storageCity}&appid=e87a11268be0c46ef77d272eeef4198d&units=metric`)
    .then(resp => resp.json())
    .then(resp => data(resp));
}
...
export default forecastStorage;